...
resource "aws_route53_record" "mongodb" {
  zone_id = var.zone_id
  name    = "mongodb-${var.environment}.${var.domain_name}" #mongodb-dev.daws86s.help
  type    = "A"
  ttl     = 1
...
resource "aws_route53_record" "redis" {
  zone_id = var.zone_id
  name    = "redis-${var.environment}.${var.domain_name}" #mongodb-dev.daws86s.help
  type    = "A"
  ttl     = 1
...
resource "aws_route53_record" "mysql" {
  zone_id = var.zone_id
  name    = "mysql-${var.environment}.${var.domain_name}" #mongodb-dev.daws86s.help
  type    = "A"
  ttl     = 1
...
resource "aws_route53_record" "rabbitmq" {
  zone_id = var.zone_id
  name    = "rabbitmq-${var.environment}.${var.domain_name}" #mongodb-dev.daws86s.help
  type    = "A"
  ttl     = 1
